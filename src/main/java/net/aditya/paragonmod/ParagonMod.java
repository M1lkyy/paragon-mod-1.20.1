...
@Mod(ParagonMod.MOD_ID)
public class ParagonMod {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "paragonmod";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public ParagonMod(FMLJavaModLoadingContext context)
    {
    ...
    public void onWorldChange(PlayerEvent.PlayerChangedDimensionEvent event) {
        ...
        if (event.getTo().equals(DoubleTree.MYSTICITY)) {
            DoubleTree.place(player);
        }
    }
